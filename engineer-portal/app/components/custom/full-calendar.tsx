...
const CalendarDayView = () => {
  ...
  return (
    <div className="flex relative overflow-auto h-full">
      <TimeTable />
...
const CalendarMonthView = () => {
  ...
  return (
    <div className="h-full flex flex-col">
      <div className="grid grid-cols-7 gap-px sticky top-0 bg-transparent border">
        {weekDays.map((day, i) => (
          <div
            key={day}
            className={cn(
              'py-4 text-right text-sm text-primary flex justify-center items-center border-l first:border-l-0 last:border-none',
              [0, 6].includes(i) && 'text-primary'
            )}
          >
            {day.toUpperCase()}
          </div>
