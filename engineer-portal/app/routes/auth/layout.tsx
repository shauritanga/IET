            ...
            <div className="auth-right">
                ...
                <div className="auth-welcome-card">
                    <div style={{ fontSize: 15, fontWeight: 700, color: "white", marginBottom: 8 }}>
                        {isPasswordFlow ? "Account Recovery" : "Welcome To IET Engineer Portal"}
                    </div>
                    <div style={{ fontSize: 12, color: "rgba(255,255,255,.72)", lineHeight: 1.65, marginBottom: 14 }}>
                        {isPasswordFlow
                            ? "Password reset links are sent to your registered email and expire after 1 hour. Request a new link if the current one no longer works."
